...
"""
import question1
from question1 import profile,total,grade,percent,max,min
m=[]
while True:
    ...
    match ch:
        case 1:
            ...
            for i in range(5):
                ...
                m.append(x)
            profile.profile(n,id,m)
        case 2:
            print("total marks",total.total(m))
        case 3:
            print("total percent",percent.percent(m))
        case 4:
            print("grade",grade.grade(m))
        case 5:
            profile.profile(n,id,m)
            print("total marks",total.total(m))
            print("total percent",percent.percent(m))
            print("grade",grade.grade(m))
            print("maximum marks",max.ma(m))
            print("minimum marks",min.mi(m))
